  ...
  return (
    ...
    >
      {imageUrl ? (
        ...
        <img alt={`Profilbillede for ${name}`} className="aspect-[4/5] w-full bg-[#F4F0F7] object-cover object-center" src={imageUrl} />
      ) : (
        <span className="grid aspect-[4/5] w-full place-items-center bg-[#F4F0F7] text-5xl font-semibold text-[#7A5D91]">
